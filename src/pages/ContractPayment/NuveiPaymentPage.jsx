...
import styles from './NuveiPaymentPage.module.css';
  ...
  const handlePaymentSuccess = async (paymentResult) => {
    try {
      ...
      await apiClient.post('/payments/nuvei/confirm-simply-connect-payment', {
        ...
        transactionId: paymentResult.TransactionId || paymentResult.transactionId,
  ...
  return (
    <div className={styles.container}>
      <div className={styles.paymentCard}>
        ...
        <div className={styles.nuveiPaymentSection}>
