...
function TermsOfUsePage() {
    ...
    const termsContent = `
        ...
        <p>Welcome to Gig Platform! These Terms of Use ("Terms") govern your access to and use of our website, mobile applications, and services (collectively, the "Service"). Please read these Terms carefully before using the Service.</p>
        ...
        <p>Gig Platform provides an online platform that connects users seeking to obtain short-term services ("Providers") with users seeking to provide such services ("Taskers").</p>
        ...
        <ul>
            ...
            {/* Add more user conduct rules as needed */}
        </ul>

        <h3>5. Gigs and Payments</h3>
        <p>Details regarding gig posting, acceptance, payment processing (including escrow), and fees are outlined within the platform and are considered part of these Terms. Platform fees are [Specify your fee structure, e.g., X% of the transaction value plus a fixed amount].</p>
        ...
        <p>These Terms shall be governed and construed in accordance with the laws of [Your Jurisdiction, e.g., Province of Ontario, Canada], without regard to its conflict of law provisions.</p>

        <h3>11. Changes to Terms</h3>
        <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.</p>

        <h3>12. Contact Us</h3>
        <p>If you have any questions about these Terms, please contact us at: [Your Contact Email/Support Link]</p>
    `;
