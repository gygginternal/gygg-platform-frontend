...
import GigDetail from '../../components/GigDetailPage/GigDetail'; // The component rendering details and actions
import apiClient from '../../api/axiosConfig';
import { Elements } from '@stripe/react-stripe-js';
import { loadStripe } from '@stripe/stripe-js';
import ContractDetailsSection from '../../components/ContractDetailsPage/ContractDetailsSection';
...
function GigDetailPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const { data: _data } = gigResponse;
      setGigData(_data.data.gig);
  ...
  }, [gigId]); // Dependency array includes gigId
  ...
  const handleAcceptSuccess = _data => {
