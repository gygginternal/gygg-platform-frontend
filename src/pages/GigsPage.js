...
export default function GigsPage() { // Use default export for pages usually
  return (
    ...
    <div className={styles.pageContainer}> {/* Optional page-specific container */}
        {/* Header and Sidebar are likely rendered globally in App.js */}
        {/* If not, uncomment them here */}
        {/* <Header /> */}
        <div className={styles.contentLayout}>
            {/* <ProfileSidebar /> */} {/* Assuming ProfileSidebar is static info, not main nav */}
            <div className={styles.taskListContainer}> {/* Wrapper for TaskList */}
                 <h2 className={styles.pageTitle}>Available Gigs</h2> {/* Add a title */}
                <TaskList />
            </div>
        </div>
    </div>
