// src/components/Onboarding/FormInput.js (Example if different from global InputField)
import React from 'react';
import styles from './FormInput.module.css'; // Create this

function FormInput({ label, name, type = "text", value, onChange, required = false, placeholder = "", ...props }) {
