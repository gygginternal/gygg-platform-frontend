// src/components/Onboarding/TaskSelector.js
...
function TaskSelector({ label = "What tasks can you help with?", selectedCategory, onCategoryChange }) {
  ...
  return (
    <div className={styles.container}> {/* Use .container from your CSS */}
      ...
      <div className="relative" style={{ position: 'relative' }}> {/* Helper for dropdown positioning */}
        <div
        ...
        >
          <div className={styles.selected}> {/* Use .selected from your CSS */}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginLeft: 'auto' }}> {/* Helper for icons */}
              {selectedCategory && (
                <button
