...
export function SimplifiedStripeOnboarding() {
  ...
  const initiateOnboarding = async () => {
    try {
      ...
      const response = await apiClient.post('/payments/initiate-account-session');
    ...
    return (
      <div className={styles.container}>
        <div className={styles.redirecting}>
          ...
          <p>Please complete your account setup and you'll be brought back to this page.</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className={styles.container}>
        <div className={styles.success}>
          ...
          <p>Your payment account is fully set up and ready to accept payments.</p>
  ...
  return (
    <div className={styles.container}>
      <div className={styles.onboardingCard}>
        <h3>{accountStatus ? 'Update Your Payment Information' : 'Complete Your Payment Setup'}</h3>
        <p>To receive payments, please complete your payment account verification.</p>
