...
export const ROUTE_CONFIGS = {
  ...
  highPriority: ['/messages', '/profile', '/contracts', '/billing'],

  // Medium priority routes - preload on hover/focus
  mediumPriority: ['/settings', '/gigs/create', '/posts/create'],

  // Low priority routes - load on demand only
  lowPriority: ['/terms', '/privacy', '/gig-helper'],
};
...
export const shouldPreloadRoute = route => {
  return (
    ROUTE_CONFIGS.critical.includes(route) ||
